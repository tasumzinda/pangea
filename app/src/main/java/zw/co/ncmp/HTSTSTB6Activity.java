...
public class HTSTSTB6Activity extends MenuBar implements View.OnClickListener {

    HTSTSTB6 registerForm;
    Spinner facility;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (registerForm_id != 0) {
            registerForm = HTSTSTB6.get(registerForm_id);
            ...
            setSupportActionBar(createToolBar("HTS_TST B6 - Update"));
        } else {
            registerForm = new HTSTSTB6();
        ...
        btn_question_one.setText("HTS_TST B6-HIV Tested And Received Results Disaggregated By Age/Sex");

        btn_question_two = (Button) findViewById(R.id.btn_question_two);
        btn_question_two.setOnClickListener(this);
        btn_question_two.setText("HTS_TST B6-Tested HIV Positive Disaggregated By Age/Sex");
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == btn_save.getId()) {
            if (validate()) {
                ...
                registerForm.save();
                btn_submit.setVisibility(View.VISIBLE);
                AppUtil.createShortNotification(HTSTSTB6Activity.this, "Saved");
            } else {
                return;
            }
        }
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            if (validate()) {
                                ...
                                registerForm.save();
                                AppUtil.createLongNotification(HTSTSTB6Activity.this, "Submitted for Upload to Server");
                                Intent intent = new Intent(HTSTSTB6Activity.this, HTSTSTB6ListActivity.class);
    ...
    public void upDateForm() {
        btn_question_one.setText("HTS_TST B6-HIV Tested And Received Results Disaggregated By Age/Sex [ " + (registerForm.getMaleIndividuals() + registerForm.getFemaleIndividuals()) + " ]");
        btn_question_two.setText("HTS_TST B6-TestedHIV Positive Results Disaggregated By Age/Sex [ " + (registerForm.getMaleCouples() + registerForm.getFemaleCouples()) + " ]");
        }
