...
public enum ReasonForUnwillingnessToBeTested {
    ...
    FEELING_SCARED(1), NEED_MORE_TIME_TO_PREPARE_FOR_TEST(2), NEED_TO_CONSULT_PARTNER_OR_SIGNIFICANT_OTHER(3), DECLINED_WITH_NO_EXPLANATION(4), IN_A_HURRY(5), OTHER(6);
