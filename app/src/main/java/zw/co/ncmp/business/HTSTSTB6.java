 ...
 */
@Table(name = "htsts_b6")
public class HTSTSTB6 extends Model {
    ...
    public static HTSTSTB6 get(Long id) {
        return new Select().from(HTSTSTB6.class).where("Id = ?", id).executeSingle();
    }

    public static List<HTSTSTB6> getFilesToUpload() {
        return new Select()
                .from(HTSTSTB6.class)
    ...
    public static List<HTSTSTB6> getAll() {
        return new Select()
                .from(HTSTSTB6.class)
    ...
    public static void deleteAll() {
        new Delete().from(HTSTSTB6.class).execute();
    }
    ...
    public static HTSTSTB6 fromJson(JSONObject jsonObject) {
        HTSTSTB6 i = new HTSTSTB6();
        try {
    ...
    public static ArrayList<HTSTSTB6> fromJson(JSONArray jsonArray) {
        ArrayList<HTSTSTB6> list = new ArrayList<>(jsonArray.length());
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            HTSTSTB6 business = HTSTSTB6.fromJson(item);
            if (business != null) {
                list.add(business);
            }
        }
