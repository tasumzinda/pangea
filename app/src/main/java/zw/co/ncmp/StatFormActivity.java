...
public class StatFormActivity extends MenuBar implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //newTBCases = (Button) findViewById(R.id.btn_new_tb_cases);
        denomDisagg = (Button) findViewById(R.id.btn_denom_disagg);
        ...
        /*newTBCases.setOnClickListener(this);
        newTBCases.setText(getResources().getString(R.string.tb_stat_question_four));
        denomDisagg.setText(getResources().getString(R.string.denominator_disaggregation));*/
        denomDisagg.setOnClickListener(this);
    ...
    public void questionFour() {
        ...
        final TextView maleTotal = (TextView) dialog.findViewById(R.id.maleTotal);
        maleTotal.setText(AppUtil.getLongValue(form.maleDenom()));

        final TextView femaleTotal = (TextView) dialog.findViewById(R.id.femaleTotal);
        femaleTotal.setText(AppUtil.getLongValue(form.femaleDenom()));
    ...
    public void upDateForm() {
        ...
        denomDisagg.setText(this.getString(R.string.denominator_disaggregation)
                + " [ " + (form.maleDenom() + form.femaleDenom()) + " ]");
        /*newTBCases.setText(this.getString(R.string.tb_stat_question_four)
