...
public class TXRETFormActivity extends MenuBar implements View.OnClickListener {
    ...
    EditText numeratorPregnant;
    EditText denominatorPregnant;
    EditText numeratorBreastFeeding;
    EditText denominatorBreastFeeding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tx_ret_form_activity);
        ...
        numeratorPregnant = (EditText) findViewById(R.id.numeratorPregnant);
        denominatorPregnant = (EditText) findViewById(R.id.denominatorPregnant);
        numeratorBreastFeeding = (EditText) findViewById(R.id.numeratorBreastFeeding);
        denominatorBreastFeeding = (EditText) findViewById(R.id.denominatorBreastFeeding);
        ...
        if (form_id != 0) {
            ...
            setSupportActionBar(createToolBar("TX_RET Update"));
        } else {
            form = new TXRETForm();
            setSupportActionBar(createToolBar("TX_RET"));
        }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == btn_save.getId()) {
            if (validate()) {
                ...
                form.denominatorBreastFeeding = AppUtil.getLongValue(denominatorBreastFeeding.getText().toString());
                ...
                form.save();
                btn_submit.setVisibility(View.VISIBLE);
                AppUtil.createShortNotification(TXRETFormActivity.this, "Saved");
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            if (validate()) {
                                ...
                                form.save();
                                AppUtil.createLongNotification(TXRETFormActivity.this, "Submitted for Upload to Server");
                                Intent intent = new Intent(TXRETFormActivity.this, TXRETFormListActivity.class);
    ...
    public void upDateForm() {
        ...
        btn_question_two.setText(this.getString(R.string.tx_ret_question_two)
