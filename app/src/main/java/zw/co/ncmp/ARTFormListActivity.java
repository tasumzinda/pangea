...
public class ARTFormListActivity extends MenuBar implements AdapterView.OnItemClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.add_list_view);
        ARTFormAdapter adapter = (new ARTFormAdapter(this, new ArrayList<ARTForm>(ARTForm.getAll())));
        ListView listView = (ListView) findViewById(R.id.list);
        listView.setEmptyView(findViewById(R.id.empty));
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(this);
        setSupportActionBar(createToolBar("ART Reported"));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ARTForm item = (ARTForm) parent.getAdapter().getItem(position);
        Intent intent = new Intent(ARTFormListActivity.this, ARTFormActivity.class);
