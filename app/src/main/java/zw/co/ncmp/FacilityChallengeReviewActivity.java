...
public class FacilityChallengeReviewActivity extends MenuBar implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FacilityChallenge oldFacilityChallenge = FacilityChallenge.get(id);
        ...
        facilityChallenge.detail = oldFacilityChallenge.detail;
        facilityChallenge.others = oldFacilityChallenge.others;
        facilityChallenge.achievable = oldFacilityChallenge.achievable;
        facilityChallenge.realistic = oldFacilityChallenge.realistic;
        facilityChallenge.specific = oldFacilityChallenge.specific;
        facilityChallenge.actionCategory = oldFacilityChallenge.actionCategory;

        caseFile = CaseFile.get(case_file_id);
        facilityChallenge.caseFile = caseFile;
        facilityChallenge.previousChallenge = oldFacilityChallenge;
        ...
        setSupportActionBar(createToolBar("Review Facility Challenge"));
        ...
        expected_outcome.setEnabled(false);
        follow_up_date.setEnabled(false);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(FacilityChallengeReviewActivity.this, CaseFileViewActivity.class);
        intent.putExtra(AppUtil.CASE_ID, caseFile.getId());
        startActivity(intent);
        finish();
    }
