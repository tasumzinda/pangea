 ...
 */
public class COP17TXNewActivity extends MenuBar implements View.OnClickListener {

    private COP17TXNew txtNew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cop17_txt_new_form_activity);
        ...
        if (txtNew_id != 0) {
            txtNew = COP17TXNew.get(txtNew_id);
            pregnant.setText(AppUtil.getLongValue(txtNew.pregnant));
            breastFeeding.setText(AppUtil.getLongValue(txtNew.breastFeeding));
            ...
            setSupportActionBar(createToolBar("TX_NEW: COP17-DSD"));
        } else {
            txtNew = new COP17TXNew();
            setSupportActionBar(createToolBar("TX_NEW: COP17-DSD"));
        }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == btn_save.getId()) {
            if (validate()) {
                ...
                txtNew.pregnant = AppUtil.getLongValue(pregnant.getText().toString());
                txtNew.breastFeeding = AppUtil.getLongValue(breastFeeding.getText().toString());
                txtNew.save();
                btn_submit.setVisibility(View.VISIBLE);
                AppUtil.createShortNotification(COP17TXNewActivity.this, "Saved");
            } else {
                return;
            }
        }
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            if (validate()) {
                                ...
                                txtNew.save();
                                AppUtil.createLongNotification(COP17TXNewActivity.this, "Submitted for Upload to Server");
                                Intent intent = new Intent(COP17TXNewActivity.this, COP17TXNewListActivity.class);
    ...
    public void questionOne() {
        ...
        if (txtNew != null) {
            ...
            maleTwentyFiveToFortyNine.setText(AppUtil.getLongValue(txtNew.maleTwentyFiveToFortyNine1));
            femaleTwentyFiveToFortyNine.setText(AppUtil.getLongValue(txtNew.femaleTwentyFiveToFortyNine1));
