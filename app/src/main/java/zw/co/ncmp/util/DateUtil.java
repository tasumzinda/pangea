...
public class DateUtil {
    ...
    /*public static int getYears(Date then){
        DateTime now = DateTime.now();
        DateTime past = new DateTime(then.getTime());
        return Years.yearsBetween(past, now).getYears();
    }

    public static int getWeeks(Date then){
        DateTime now = DateTime.now();
        DateTime past = new DateTime(then.getTime());
        return Weeks.weeksBetween(past, now).getWeeks();
    }
