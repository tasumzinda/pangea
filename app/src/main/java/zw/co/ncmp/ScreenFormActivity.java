...
public class ScreenFormActivity extends MenuBar implements View.OnClickListener {
    ...
    EditText positiveScreen;
    EditText negativeScreen;
    EditText denomSpecimenSent;
    EditText denomSmear;
    EditText denomOthers;
    EditText denomExpert;
    Button questionTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        positiveScreen = (EditText) findViewById(R.id.positive_screen);
        negativeScreen = (EditText) findViewById(R.id.negative_screen);
        denomSpecimenSent = (EditText) findViewById(R.id.denomSpecimenSent);
        denomSmear = (EditText) findViewById(R.id.denomSmear);
        denomOthers = (EditText) findViewById(R.id.denom_others);
        denomExpert = (EditText) findViewById(R.id.denom_xpert);
        questionTwo = (Button) findViewById(R.id.btn_question_two);
        ...
        if (form_id != 0) {
            form = ScreenForm.get(form_id);
            numerator.setText(String.valueOf(form.numerator));
            name.setText(String.valueOf(form.name));
            denominator.setText(String.valueOf(form.denominator));
            positiveScreen.setText(String.valueOf(form.positiveScreen));
            negativeScreen.setText(String.valueOf(form.negativeScreen));
            denomSpecimenSent.setText(String.valueOf(form.denomSpecimenSent));
            denomSmear.setText(String.valueOf(form.denomSmear));
            denomOthers.setText(String.valueOf(form.denomOthers));
            denomExpert.setText(String.valueOf(form.denomExpert));
            ...
            setSupportActionBar(createToolBar("TX_TB Update"));
        } else {
            form = new ScreenForm();
            setSupportActionBar(createToolBar("TX_TB"));
        }

        btn_question_one = (Button) findViewById(R.id.btn_question_one);
        btn_question_one.setOnClickListener(this);
        btn_question_one.setText(R.string.numerator_disaggregation);
        questionTwo.setText(R.string.denominator_disaggregation);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == btn_save.getId()) {
            if (validate()) {
                ...
                form.positiveScreen = AppUtil.getLongValue(positiveScreen.getText().toString());
                form.negativeScreen = AppUtil.getLongValue(negativeScreen.getText().toString());
                form.denomSpecimenSent = AppUtil.getLongValue(denomSpecimenSent.getText().toString());
                form.denomSmear = AppUtil.getLongValue(denomSmear.getText().toString());
                form.denomOthers = AppUtil.getLongValue(denomOthers.getText().toString());
                form.denomExpert = AppUtil.getLongValue(denomExpert.getText().toString());
    ...
    public boolean validate() {
        ...
        if(positiveScreen.getText().toString().isEmpty()){
            positiveScreen.setError("Required");
            valid = false;
        }else{
            positiveScreen.setError(null);
        }

        if(negativeScreen.getText().toString().isEmpty()){
            negativeScreen.setError("Required");
            valid = false;
        }else{
            negativeScreen.setError(null);
        }

        if(denomSpecimenSent.getText().toString().isEmpty()){
            denomSpecimenSent.setError("Required");
            valid = false;
        }else{
            denomSpecimenSent.setError(null);
        }

        if(denomSmear.getText().toString().isEmpty()){
            denomSmear.setError("Required");
            valid = false;
        }else{
            denomSmear.setError(null);
        }

        if(denomOthers.getText().toString().isEmpty()){
            denomOthers.setError("Required");
            valid = false;
        }else{
            denomOthers.setError(null);
        }
    ...
    public void upDateForm() {
        ...
        btn_question_one.setText(getResources().getString(R.string.numerator_disaggregation)
                + " [ " + (form.maleQuestion1() + form.femaleQuestion1()) + " ]");
        questionTwo.setText(this.getString(R.string.denominator_disaggregation)
